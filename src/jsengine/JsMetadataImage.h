...
#ifndef guard_jsmetadataimage_h
#define guard_jsmetadataimage_h

#include <jsapi.h>

#include "../server/metadataimage.h"

/**
* JsMetadataImage.
* JavaScript representation of the MetadataImage class.
*/
class JsMetadataImage
{
public:
	/**
	...
	* @param image the metadata image instance
	* @return the new instance object
	*/
	static JSObject* jsInstance(JSContext *cx,JSObject *obj,MetadataImage::Ptr imagePtr);
	...
	* Get the image data.
	*/
	static JSBool getData(JSContext *cx,JSObject *obj,uintN argc,jsval *argv,jsval *rval);

	/**
	* Get the mime type of the image.
	*/
	static JSBool getMimeType(JSContext *cx,JSObject *obj,uintN argc,jsval *argv,jsval *rval);
