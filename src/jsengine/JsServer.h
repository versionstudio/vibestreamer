...
#ifndef guard_jsserver_h
#define guard_jsserver_h

#include <jsapi.h>

/**
* JsServer.
* Javascript class representing server functionality and is
* used for retrieving the singleton instances and managers from the server core.
*/
class JsServer
{
public:
	...
	*/
	static JSBool getDatabaseManager(JSContext *cx,JSObject *obj,uintN argc,jsval *argv,jsval *rval);

	/**
	* Get the http server singleton instance.
	*/
	static JSBool getHttpServer(JSContext *cx,JSObject *obj,uintN argc,jsval *argv,jsval *rval);

	/**
	* Get the indexer instance.
	*/
	static JSBool getIndexer(JSContext *cx,JSObject *obj,uintN argc,jsval *argv,jsval *rval);

	/**
	* Get the log manager singleton instance.
	*/
	static JSBool getLogManager(JSContext *cx,JSObject *obj,uintN argc,jsval *argv,jsval *rval);

	/**
	* Get the share manager singleton instance.
	*/
	static JSBool getShareManager(JSContext *cx,JSObject *obj,uintN argc,jsval *argv,jsval *rval);

	/**
	* Get the user manager singleton instance.
	*/
	static JSBool getUserManager(JSContext *cx,JSObject *obj,uintN argc,jsval *argv,jsval *rval);
