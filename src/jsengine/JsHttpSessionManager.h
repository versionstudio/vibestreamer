...
#ifndef guard_jshttpsessionmanager_h
#define guard_jshttpsessionmanager_h

#include <jsapi.h>

/**
* JsHttpSessionManager.
* Javascript representation of the HttpSessionManager class.
*/
class JsHttpSessionManager
{
public:
	/**
	...
	*/
	...
	/**
	* Find and return session by guid.
	*/
	static JSBool findSessionByGuid(JSContext *cx,JSObject *obj,uintN argc,jsval *argv,jsval *rval);

	/**
	* Get a collection of all sessions.
	*/
	static JSBool getSessions(JSContext *cx,JSObject *obj,uintN argc,jsval *argv,jsval *rval);
