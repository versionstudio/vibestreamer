...
#ifndef guard_jshttpclientresponse_h
#define guard_jshttpclientresponse_h
...
/**
* JsHttpClientResponse.
* JavaScript representation of the HttpClientResponse class.
*/
class JsHttpClientResponse
{
public:
	/**
	...
	*/
	static JSObject* jsInstance(JSContext *cx,JSObject *obj,HttpClientResponse *privateData);
	...
	*/
	static JSBool getBody(JSContext *cx,JSObject *obj,uintN argc,jsval *argv,jsval *rval);

	/**
	* Get the response http header.
	*/
	static JSBool getHeader(JSContext *cx,JSObject *obj,uintN argc,jsval *argv,jsval *rval);
	
	/**
	* Get the http status code of the response.
	*/
	static JSBool getStatusCode(JSContext *cx,JSObject *obj,uintN argc,jsval *argv,jsval *rval);
